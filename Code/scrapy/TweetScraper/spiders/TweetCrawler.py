...
class TweetScraper(CrawlSpider):
    ...
    def __init__(self, query=''):
        self.url = (
            ...
            f'include_profile_interstitial_type=false'
            f'&include_blocking=false'
            f'&include_blocked_by=false'
            f'&include_followed_by=false'
            f'&include_want_retweets=false'
            f'&include_mute_edge=false'
            f'&include_can_dm=false'
            f'&include_can_media_tag=false'
            f'&skip_status=false'
            f'&cards_platform=Web-12'
            f'&include_cards=false'
            f'&include_ext_alt_text=false'
            f'&include_quote_count=false'
            f'&include_reply_count=false'
            f'&tweet_mode=false'
            f'&include_entities=false'
            f'&include_user_entities=false'
            f'&include_ext_media_color=false'
            f'&include_ext_media_availability=false'
            f'&send_error_codes=false'
            f'&simple_quoted_tweet=false'
            f'&query_source=false'
            f'&pc=false'
            f'&spelling_corrections=false'
